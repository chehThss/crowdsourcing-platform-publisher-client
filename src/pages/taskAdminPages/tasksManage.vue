<template>
  <div>
    ...
    <div>
      <Card v-for="(item, index) in populatedTaskList" :key="item._id">
        <Row type="flex">
          <Col span="20">
            <h2><router-link
              :to="{name: 'taskManageInfo', params: {id: item._id}}"
            ...
            <div v-if="$store.state.user.users[item.publisher]" class="publisher-info">
              ...
              <img v-else :src="defaultAvatar" class="publisher-avatar"/>
