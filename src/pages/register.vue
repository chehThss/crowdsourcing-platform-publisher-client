<template>
  <div class="register-page">
    ...
    <Form class="register-form"
          ref="formValidate"
          :label-width="80">
      <FormItem :error="formRegister.email.error"
                label="邮箱：">
        <Input type="text"
               v-model="formRegister.email.content"
               placeholder=""
               autofocus></Input>
      </FormItem>
      <FormItem :error="formRegister.username.error"
                label="用户名：">
        <Input type="text"
               v-model="formRegister.username.content"
               placeholder=""></Input>
      </FormItem>
      <FormItem :error="formRegister.password.error"
                label="密码：">
        <Input type="password"
               v-model="formRegister.password.content"
               placeholder=""></Input>
      </FormItem>
      <FormItem :error="formRegister.passwordCheck.error"
                label="确认密码：">
        <Input type="password"
               v-model="formRegister.passwordCheck.content"></Input>
      </FormItem>
